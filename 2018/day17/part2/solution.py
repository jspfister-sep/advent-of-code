...
class Map:
    ...
    def still_water_count(self):
        return len([tile for tile in self.data.values() if tile == self.STILL_WATER])
...
print('Number of retained water tiles: {}'.format(map.still_water_count()))
