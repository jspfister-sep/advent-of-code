        ...
        while len(q) > 0:
            ...
            for n in room.neighbors.values():
                if n and n.distance_from_start > room.distance_from_start + 1:
                    ...
                    q.append(n)
        return max(self.rooms.values(), key=lambda r: r.distance_from_start).distance_from_start
...
print('The furthest room is {} doors away'.format(map.find_max_doors()))
